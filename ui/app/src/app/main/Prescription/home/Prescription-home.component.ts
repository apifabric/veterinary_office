...
@Component({
  selector: 'Prescription-home',
  templateUrl: './Prescription-home.component.html',
  styleUrls: ['./Prescription-home.component.scss']
})
export class PrescriptionHomeComponent implements AfterViewInit {
