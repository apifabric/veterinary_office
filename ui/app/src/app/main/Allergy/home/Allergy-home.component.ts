...
@Component({
  selector: 'Allergy-home',
  templateUrl: './Allergy-home.component.html',
  styleUrls: ['./Allergy-home.component.scss']
})
export class AllergyHomeComponent implements AfterViewInit {
