...
@Component({
  selector: 'MedicineSupply-home',
  templateUrl: './MedicineSupply-home.component.html',
  styleUrls: ['./MedicineSupply-home.component.scss']
})
export class MedicineSupplyHomeComponent implements AfterViewInit {
