...
resourcename="veterinaryoffice"  # lower case, only
resourcegroup="veterinaryoffice_rg"
...
# git clone https://github.com/apilogicserver/veterinaryoffice.git
# cd veterinaryoffice
...
az group create --name veterinaryoffice_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group veterinaryoffice_rg --sku S1 --is-linux
az container create --resource-group veterinaryoffice_rg --name veterinaryoffice --image apilogicserver/veterinaryoffice:latest --dns-name-label veterinaryoffice --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//veterinaryoffice.westus.azurecontainer.io:5656'
